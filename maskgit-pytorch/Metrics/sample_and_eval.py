...
class SampleAndEval:
    ...
    def compute_and_log_metrics(self, module, teacher=None):
        with torch.no_grad():
            ...
            self.compute_fake_images_features(module, module.test_data, teacher=teacher)
    ...
    def compute_fake_images_features(self, module, dataloader, teacher=None):
        if len(dataloader.dataset) < self.num_images:
            max_images = len(dataloader.dataset)
        else:
            max_images = self.num_images
